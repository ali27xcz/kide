...
class AppConstants {
  ...
  // Success threshold across games (score/maxScore >= this ratio => success)
  static const double passScoreRatio = 0.6;
  ...
  static const String memoryGame = 'memory';
   ...
   static const String codeLearningGame = 'code_learning';
