class AppSounds {
  // Background Music
  static const String backgroundMusic = 'sounds/Game-Background.mp3';
  static const String gamesMenuBackgroundMusic = 'sounds/Game-Background-gamesmenu.mp3';
  // Global End Game sound
  static const String endGame = 'sounds/endgame.mp3';
  
  // Game Sounds
  static const String correctAnswer = 'sounds/win.mp3';
  // Per-question wrong answer sound (new)
  static const String incorrectAnswer = 'sounds/error-answer.mp3';
  ...
  // End of game failure sound (new)
  static const String gameOver = 'sounds/game-over.mp3';
